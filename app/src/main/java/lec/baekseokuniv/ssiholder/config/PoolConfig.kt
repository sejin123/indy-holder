...
object PoolConfig {
    ...
    fun createPool(): String {
        ...
        val genesisTxnFilePath: String = getTxnFilePath("temp.txn").absolutePath
    ...
    private fun getTxnFilePath(fileName: String): File {
        //TODO: issuer server setting 완료 후 아래 값 변경 (20230711 ksh)
        val temporaryPath = "${FileUtils.getTempDirectoryPath()}/indy/$fileName"
        val poolIp = System.getenv("TEST_POOL_IP")?:"127.0.0.1"
